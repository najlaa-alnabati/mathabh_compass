...
function switchPositionsLayer2() {
  ...
  const textBox = document.getElementById('myTextArea2');
...
function switchPositionsLayer3() {
  ...
  const textBox = document.getElementById('myTextArea3');
...
function switchPositionsLayer4() {
  ...
  const textBox = document.getElementById('myTextArea4');
  ...
  if (selectedText === 'المسجد الحرام') {
    ...
    imageElement5.src = '348008867.jpg'; // Set the image source
...
function switchPositionsLayer5() {
  ...
  const textBox = document.getElementById('myTextArea5');
